...
export const ErrorCode = {
  ...
  // ---- MCP OAuth 2.1 remediation (specs/mcp-auth-remediation-plan.md) ----
  AUTH_TOKEN_INVALID: "AUTH_TOKEN_INVALID",
  INSUFFICIENT_SCOPE: "INSUFFICIENT_SCOPE",
  DELEGATION_REVOKED: "DELEGATION_REVOKED",
  DELEGATION_EXPIRED: "DELEGATION_EXPIRED",
  DELEGATION_NOT_FOUND: "DELEGATION_NOT_FOUND",
  AI_WALLET_NOT_PROVISIONED: "AI_WALLET_NOT_PROVISIONED",
  AI_WALLET_OWNER_MISMATCH: "AI_WALLET_OWNER_MISMATCH",
  AI_WALLET_ALREADY_BOUND: "AI_WALLET_ALREADY_BOUND",
  AI_SIGNER_NOT_GRANTED: "AI_SIGNER_NOT_GRANTED",
...
export const ERROR_HTTP_STATUS: Readonly<Record<ErrorCode, number>> = {
  ...
  AI_WALLET_NOT_PROVISIONED: 409,
  AI_WALLET_OWNER_MISMATCH: 403,
  AI_WALLET_ALREADY_BOUND: 409,
  AI_SIGNER_NOT_GRANTED: 409,
  CONSENT_REQUEST_INVALID: 400,
};
